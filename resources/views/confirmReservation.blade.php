                ...
                <div class="product-info">
                    <div class="row">
                        ...
                        <div class="block-heading" style="margin-top: -60px" >
                            <button  type="submit" name="send" value="" id="sendRes" class="btn btn-success" style="margin-left: 5px;background-color: orangered;border: none; " type="submit"><svg xmlns="http://www.w3.org/2000/svg"  style="margin-top:-8px;" width="18" height="18" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
