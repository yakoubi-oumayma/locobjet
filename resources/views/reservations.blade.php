                                        ...
                                        <div class="clean-product-item">
                                            ...
                                            <div class="product-name">
                                                ...
                                                <button class="btn btn-danger" style="margin-left: 5px;" type="submit"
                                                    ...
                                                    <i class="fa fa-x" style="font-size: 15px; color: white"></i>Refuser
                                                </button>
                                            </div>
                                            <!-- Modal -->
...
{{--                                                                          style="width: 100%; height: 150px;">{{$item->description}}</textarea>--}}
{{--                                                                <h5>Price</h5>--}}
...
{{--                                                            </div>--}}
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" class="btn btn-primary">Accepte
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
