                        ...
                        <div class="col-md-6">
                            <div class="gallery">
                                <div id="product-preview" class="vanilla-zoom">
                                    ...
                                    <div class="sidebar"><img class="img-fluid d-block small-preview" src="{{asset("assets/img/tech/image2.jpg")}}"><img class="img-fluid d-block small-preview" src="{{asset("assets/img/tech/image1.jpg")}}"><img class="img-fluid d-block small-preview" src="{{asset("assets/img/tech/image2.jpg")}}"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info">
                                ...
                                <div class="price">
                                    <h3>{{$ad->price}} MAD</h3>
                                </div><button class="btn btn-primary" type="button"><i class="icon-basket"></i>Réserver</button>
                                <div class="summary">
                                    <p>{{$ad->description}}</p>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active description" role="tabpanel" id="description">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <figure class="figure"><img class="img-fluid figure-img" src="{{asset("assets/img/tech/image3.png")}}"></figure>
                                    </div>
                                    <div class="col-md-7">
                                        <h4>Lorem Ipsum</h4>
